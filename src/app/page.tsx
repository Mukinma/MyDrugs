...
export default function Home() {
  return (
    <div className="min-h-screen md:pl-[calc(18rem+1rem)]">
      ...
      <main className="px-0 md:px-0">
        ...
        <section id="about" className="border-t py-12">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <p className="mt-2 max-w-2xl text-sm/6 opacity-80">
              Este proyecto es un prototipo visual inspirado en una serie. No
              hay backend ni lógica de compra (de momento); el foco es
              experimentar con UI, tipografía y telemetría básica con Amplitude.
            </p>
          </div>
        </section>
        <section id="faq" className="border-t py-12">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <p className="mt-2 max-w-2xl text-sm/6 opacity-80">
              Próximamente: guía rápida sobre seguridad, envíos, pagos y
              trazabilidad.
            </p>
          </div>
        </section>
